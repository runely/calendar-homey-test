      ...
      try {
        ...
        if (event.recurrences !== undefined) {
          for (const r of Object.keys(event.recurrences)) {
            ...
            const rMoment = event.recurrences[r].start.toUTCString().includes('00:00:00') ? moment(event.recurrences[r].start) : moment.tz(event.recurrences[r].start, usedTZ)
            ...
            if (dateAdded) console.log(`Recurrence in '${event.uid}' was moved from '${rMomentRecurr}' to ${rMoment}`)
          }
        }
